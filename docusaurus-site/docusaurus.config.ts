...
const config: Config = {
  ...
  organizationName: 'somosyampi', // Usually your GitHub org/user name.
  projectName: 'documentaion', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Yampi documentation.`,
    },
    prism: {
